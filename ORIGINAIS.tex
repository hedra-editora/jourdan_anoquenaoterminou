...
\versal{Camila Jourdan:} Os seguranças da \versal{UERJ} não deixaram as pessoas
...
\versal{Camila Jourdan:} Olha, isso é um absurdo sem tamanho...
...
\noindent
\versal{Confira a postagem completa da professora}
...
\noindent\emph{2 - Como você observa a construção da sua imagem e destes
...
\noindent\emph{3 - De todas as prisões durante os protestos, apenas Rafael
...
\noindent\emph{4 - Você acredita que todo preso é um preso político ou existe
...
programa de José Luiz Datena da Rede Bandeirantes?\footnote{Referência
