...
``Liga para \versal{DP} e pede outro mandado, pede apreensão''
...
batalha da \versal{ALERJ}. E eu queria narrar este dia com detalhes para ver se
...
Pedras que não param em direção à \versal{ALERJ}. Os guardas lá dentro reféns de
...
porta da \versal{ALERJ}. Centros culturais não são atacados nem depredados. Mas
...
lembrar da fogueira e dos gritos em frente a \versal{ALERJ} e de como esse dia
...
início temporal da \versal{FIP} (Frente Independente Popular)\footnote{A Frente
...
Felipe, ele é de fato a única fonte, ela não é testemunha de nada. A \versal{FIP}
teria saído do fórum do \versal{IFCS} (Instituto de Filosofia e Ciências Sociais
da \versal{UFRJ}). Teria plenárias abertas, na qual seriam aprovadas passeatas e
...
Entretanto, não havia \versal{FIP}-"\versal{MG}. Começa a falar da questão financeira, a
...
a \versal{FIP} pela morte do Santiago. Incentivada por isso eu gostaria de dizer
...
Universidade do Estado do Rio de Janeiro (\versal{UERJ}). Neste dia, várias
...
responsável pelas vidraças quebradas. Sim, as vidraças da \versal{UERJ} foram
...
estudantil da \versal{UERJ}, os estudantes tenham decidido consensualmente dar
...
mais passar na \versal{UERJ} apenas para cortar caminho até suas casas, quando
...
da \versal{UERJ}; a outra foi aberta a partir desta investigação por denúncia de
...
\textbf{Delegado:} A senhora estava presente na \versal{UERJ} no dia 28/05/2015?
...
\textbf{Delegado: O que aconteceu naquele dia na \versal{UERJ}?}

\textbf{Camila Jourdan:} Os seguranças da \versal{UERJ} não deixaram as pessoas
...
é meio fatalista dizer isso, mas basta fazer as contas, o \versal{PSOL} de hoje é
o \versal{PT} de amanhã. E esta história eleitoral se repetirá assim
...
como já ocorreu com o chegada do \versal{PT} ao poder em vários aspectos porque a
...
dizer que estes vândalos eram pagos pelo próprio \versal{PT}. Ao lado dessas duas
...
da polícia em frente à \versal{ALERJ}, mesma \versal{ALERJ} que, um mês depois, seria
...
tradicional ao poder. A chegada do \versal{PT} ao poder mostrou quão pouca
...
na medida em que o \versal{PT}, um partido vindo de movimentos sociais, se voltou
...
sociais órfãos ou destruídos por dentro, na medida em que o \versal{PT} se torna
...
Este não foi um acaso do \versal{PT}, o que ocorre é que os partidos reformistas
...
Proudhon e Bakunin, no século \versal{XIX}. A ideia básica envolvida era já a de
...
E não é por acaso que a \versal{FIP} foi principal foco da criminalização
...
programa de José Luiz Datena da Rede Bandeirantes?\footnote{\emph{\textsuperscript{Referência
  a um programa de \versal{TV} ao vivo, da Rede Bandeirantes, do dia 13/06/2013,
...
\versal{FIFA} de 2014 se aproximava e as manifestações voltavam a crescer. É aí
...
vândalos.''\footnote{\versal{DEPUIS}-\versal{DÉRI}, Francis. \emph{Black Blocs}. Tradução:
...
Mas se a \versal{PL} 2.016-F, que tifica o crime de terrorismo, estivesse já em
...
investigações foram instauradas na 18\versal{DP}, após o ato de solidariedade dos
...
programas na \versal{TV} com destaque. Não apenas aqui, mas em todo o mundo, o
...
quais eu sinto toda a fraternidade. \footnote{\versal{CAMUS}, Albert. \emph{A
...
espetáculo\footnote{Entendemos 'espetáculo' aqui no sentido cunhado por
  ...
  \emph{\versal{DEBORD}, Guy.} Sociedade do espetáculo. Rio de Janeiro:
...
panela de pressão que eles não conseguem mais controlar.\footnote{\versal{GATTARI},
...
reforma da previdência, nem privatizar a \versal{CEDAE}, nem acabar com os
direitos trabalhista, nem reformar a educação, nem suspender direitos
básicos, nem fechar a \versal{UERJ}, nem cortar os salários dos funcionários
...
de 'ajustamento estrutural'.''}\footnote{\versal{COMITÊ} \versal{INVISÍVEL}. \emph{Aos
...
burguesas a partir do século \versal{XVIII} e se arrogando oposto ao exercício de
...
como as continuações da guerra.''\footnote{\versal{FOUCAULT}, Michel. \emph{Em
...
mecanismos de poder, mesmo os mais regulares.\footnote{\versal{FOUCAULT}, Michel.
...
reacionárias que tomaram conta da situação.\footnote{\versal{GATTARI}, Félix.
...
\emph{presença}.\footnote{\versal{COMITÊ} \versal{INVISÍVEL}. \emph{Aos Nossos Amigos:
...
guerra''.\footnote{\versal{FOUCAULT}, Michel. \emph{Em defesa da Sociedade: curso
...
consideração pelos muros ilusórios do nosso Eu.\footnote{\versal{COMITÊ}
  \versal{INVISÍVEL}. \emph{Aos Nossos Amigos: Crise e Insurreição}. Tradução:
...
pública\footnote{``A ciência a qual cabe indagar qual deve ser a melhor
  constituição da Polis'' s. \versal{ARISTÓTELES}. A Política. São Paulo: Atena
  Editora, sd.}.
...
nossa resistência atual. \footnote{``Temos a nossa dignidade suprema em
  nossa significação como obra de arte'' \versal{NIETZSCHE}. O Nascimento da
