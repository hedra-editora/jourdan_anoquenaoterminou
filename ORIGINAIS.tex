...
Por que ainda publicar algo sobre 2013 e os
...
\chapter{Censura e perseguição política\footnote{Matéria sobre a censura que sofri sendo proibida de palestrar em Dourados, em 05/09/2014.}}
...
\chapter{Não existe governo de esquerda\footnote{Entrevista concedida ao \emph{Diário ao centro do mundo}, em
31/10/2016.}}
...
uniformidade nos valores e nos modos de vida\footnote{\versal{ABBAGNANO},
  Nicola. \emph{Dicionário de Filosofia}. Tradução: Alfredo Bosi. São Paulo:
...
quais eu sinto toda a fraternidade\footnote{\versal{CAMUS}, Albert. \emph{A Guerra começou, onde está a guerra?} Tradução: Raphael Araújo e Samara
...
arte''\footnote{\versal{DELEUZE}. ``O ato de criação''. Palestra proferida em
  Paris em 1987, transcrita e publicada em \emph{Folha de São Paulo}, 27 jun
