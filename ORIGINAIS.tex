...
às manifestações? Como minar o empoderamento popular? Esta efervescência
...
\emph{presença}.\footnote{\versal{COMITÊ} \versal{INVISÍVEL}. \emph{Aos Nossos Amigos:
  Crise e Insurreição}. Tradução: Edições Antipáticas. São Paulo: \versal{N}-1
  edições, 2016, p.35.}
\end{quote}
...
consideração pelos muros ilusórios do nosso Eu.\footnote{\versal{COMITÊ}
  ...
  Edições Antipáticas. São Paulo: \versal{N}-1 edições, 2016, pp.54-55.}
\end{quote}
...
uma casa são objetos de arte, mas não as nossas vidas?''\footnote{\versal{FOUCAULT},
  \versal{M}. 1994. Dits et écrits. Paris: Gallimard, 4 vols, p.617.}
\end{quote}
