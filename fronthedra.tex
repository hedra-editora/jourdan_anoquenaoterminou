...
\linhalayout{conselho consultivo}{\tiny Acácio Augusto (\versal{UNIFESP}),\\
\qquad \qquad \qquad \qquad \quad \, Amilcar Parker,\\
...
\qquad \qquad \qquad \qquad \quad \, Renato Rezende (Circuito),\\
