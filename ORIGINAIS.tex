...
e a funcionária a ignora. Tenho a impressão que os pássaros e gatos aqui riem da nossa humanidade.
...
\emph{1 -Junho e os meses na sequencia deram visibilidade a uma série
...
\emph{2 - Como você observa a construção da sua imagem e destes
...
\emph{3 - De todas as prisões durante os protestos, apenas Rafael
...
\emph{4 - Você acredita que todo preso é um preso político ou existe
...
\emph{Há quantas eleições você não vota e por que? }
...
\emph{Em algum momento pode ser necessário votar para tentar evitar o
...
\emph{A descrença na democracia representativa por parte da esquerda,
...
\emph{Um governo mais à esquerda não pode ajudar a fortalecer a luta
social?}
...
\emph{Seria impossível governar contra os interesses do chamado 1\%,
a favor de 99\%}
...
\emph{Quais ações políticas considera mais importantes que o voto
nesse momento?}
...
\emph{Há tentativas de mandatos representativos coletivos pelo país,
...
\emph{Acredita que a maioria das pessoas não foi votar por estar
