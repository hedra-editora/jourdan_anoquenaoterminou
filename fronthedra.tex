...
\end{flushleft}
J863 \hspace{9pt}Jourdan, Camila\\
\hspace{20pt}\parbox{185pt}{2013: memórias e resistências / Camila Jourdan. Prefácio de Edson Passetti.  -- Rio de Janeiro: Circuito, 2018. (Coleção Ataque)}

\hspace{20pt}182 p.: Il.\\[6pt]

\hspace{20pt}ISBN 978-85-9582-035-7\\[6pt]
...
%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{\logo}\hfill\logoum{}\\ São Paulo\_\the\year}}{\includegraphics[width=2cm]{./logo_hedra.png}\hspace{.5cm}\includegraphics[width=2cm]{CIRCUITO.jpg}\break{} Rio de Janeiro\quad2018}
